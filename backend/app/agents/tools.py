...
def get_python_tools(working_dir: str) -> PythonTools:
    ...
    return PythonTools(
        ...
        base_dir=working_dir,    # Agno handles all path management!
    )
...
def get_file_tools(working_dir: str) -> FileTools:
    ...
    return FileTools(
        base_dir=working_dir     # Agno handles path validation automatically
    )
...
def get_reasoning_extraction_tools(working_dir: str) -> List[Union[PythonTools, FileTools, ReasoningTools]]:
    """
...
def get_thinking_extraction_tools(working_dir: str) -> List[Union[PythonTools, FileTools, ThinkingTools]]:
    """
